...
export const Editar = () => {
  ...
  const conseguirArticulo = async () => {
    ...
    const url = await Global.url + "articulo/" + params.id;
  ...
  return (
    <div className="jumbo">
      ...
      <p>Formulario para <strong>editar:</strong> {articulo.titulo}</p>
      ...
      <form className="formulario" onSubmit={editarArticulo}>
        <div className="form-group">
          ...
          <input type="text" name="titulo" id="titulo" onChange={cambiado} defaultValue={articulo.titulo} />
        </div>

        <div className="form-group">
          <label htmlFor="contenido" >Contenido</label>
          <textarea type="text" name="contenido" id="contenido" onChange={cambiado} defaultValue={articulo.contenido}/>
        </div>
